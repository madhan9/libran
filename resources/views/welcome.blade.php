...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="culmn">
            ...
            <section id="strength" class="test bg-grey roomy-60 fix">
                <div class="container">
                    <div class="row">  
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="business_item mb-3 text-justify">
                                    ...
                                    <ul class="mt-3 wow fadeInRight">
                                        ...
                                        <li class="mb-3"><i class="fa  fa-arrow-circle-right "></i> Largest reference candidates by old employees.</li>
                                    </ul>
                            ...
                            <div class="col-md-6">
                                <div class="business_slid">
                                    ...
                                    <div class="business_items text-center">
                                        <div class="business_item">
                                            <div class="business_img">
                                                <img src="images/strength-img1.jpg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
           ...
           <section id="service" class="product">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <div class="container">
                                        <div class="row">
                                            @for($i=1;$i<=6;$i++)
                                            <div class="col-sm-2 service-box ">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="images/cbrands/cbrand-img{{$i}}.png" alt="" />
                                                       
                                                        <div class="port_overlay text-center">
                                                            <a href="images/cbrands/cbrand-img{{$i}}.png" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <footer id="contact" class="footer action-lage bg-black p-top-80">
                ...
                <div class="main_footer fix bg-mega text-center p-top-40 p-bottom-30 m-top-80">
                    <div class="col-md-12">
                        <p class="wow fadeInRight font-grey" data-wow-duration="1s">
                          
                            <a target="_blank" href="https://www.libran.com"></a> 
